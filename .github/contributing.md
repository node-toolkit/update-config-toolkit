# Contributing to update-config-toolkit

First and foremost, thank you! We appreciate that you want to contribute to update-config-toolkit, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for update-config-toolkit**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for update-config-toolkit:

- star the [project](https://github.com/jonschlinkert/update-config-toolkit)
- tweet your support for update-config-toolkit
...
- **version**: please note the version of update-config-toolkit are you using
...
[so]: http://stackoverflow.com/questions/tagged/update-config-toolkit